...
-- Az új tábla :(((
DROP TABLE Ut CASCADE CONSTRAINTS;
...
-- Út tábla (Isten legyen a tanúm, nem tudom enélkül elkészíteni az utasstatisztikát)
CREATE TABLE Ut (
    u_azonosito NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,    -- id
    utasszam NUMBER,                                                -- összes utas száma
    datum DATE NOT NULL                                             -- mikor történt ez az út
    jarat_azonosito NUMBER                                          -- melyik járaton történt ez az út
);
...
-- Új tábla kulcsai
ALTER TABLE Ut ADD CONSTRAINT pk_ut PRIMARY KEY(u_azonosito)
ALTER TABLE Ut ADD CONSTRAINT fk_ut_jarat FOREIGN KEY(jarat_azonosito) REFERENCES Jarat(jarat_azonosito) ON DELETE CASCADE; -- Lehet hogy null-ra állítani jobb lenne, de eh
...
INSERT INTO Ut (u_azonosito, utasszam, datum, jarat_azonosito) VALUES (1, 203, DATE '2024-05-04', 1)
INSERT INTO Ut (u_azonosito, utasszam, datum, jarat_azonosito) VALUES (2, 186, DATE '2024-05-04', 1)
INSERT INTO Ut (u_azonosito, utasszam, datum, jarat_azonosito) VALUES (3, 203, DATE '2024-06-14', 2)
INSERT INTO Ut (u_azonosito, utasszam, datum, jarat_azonosito) VALUES (4, 199, DATE '2024-07-13', 2)
INSERT INTO Ut (u_azonosito, utasszam, datum, jarat_azonosito) VALUES (5, 254, DATE '2024-04-10', 3)
INSERT INTO Ut (u_azonosito, utasszam, datum, jarat_azonosito) VALUES (6, 320, DATE '2024-04-10', 3)
INSERT INTO Ut (u_azonosito, utasszam, datum, jarat_azonosito) VALUES (7, 211, DATE '2024-08-23', 4)
INSERT INTO Ut (u_azonosito, utasszam, datum, jarat_azonosito) VALUES (8, 177, DATE '2024-08-18', 4)
INSERT INTO Ut (u_azonosito, utasszam, datum, jarat_azonosito) VALUES (9, 304, DATE '2024-11-11', 5)
INSERT INTO Ut (u_azonosito, utasszam, datum, jarat_azonosito) VALUES (10, 267, DATE '2024-11-11', 5)
